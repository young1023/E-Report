...
' Set default values
'if Search_Daily_Day = "" then
'	Search_Daily_Day = day(Session("DBLastModifiedDateValue"))
'end if	
'if Search_Daily_Month = "" then
'	Search_Daily_Month = month(Session("DBLastModifiedDateValue"))
'end if
'if Search_Daily_Year = "" then
'	Search_Daily_Year = year(Session("DBLastModifiedDateValue"))
'end if
' if  Search_SharedSelection = "" then
' 	Search_SharedSelection = "share1"
' end if
' if  Search_Market = "" then
' 	Search_Market = "ALL"
' end if
' if  Search_Instrument = "" then
' 	Search_Instrument = ""
' end if
' if  Search_LedgerBalanceType = "" then
' 	Search_LedgerBalanceType = "ALL"
' end if
' if  Search_IncludeMarginAccount = "" then
' 	Search_IncludeMarginAccount = "ALL"
' end if
' if  Search_SharedGroup = "" then
' 	Search_SharedGroup = "ALL"
' end if
'if  Search_IncludeMarginAccount = "" then
'	Search_IncludeMarginAccount = ""
'end if
'if  Search_SharedGroupMember = "" then
'	Search_SharedGroupMember = ""
'end if
...
'Search_SharedGroup  = session("SharedGroup")
'Search_SharedGroupMember  = session("SharedGroupMember")
'Search_Daily_Day    = session("SDay")
'Search_Daily_Month  = session("SMonth")
'Search_Daily_Year   = session("SYear")
'Search_LedgerBalanceType   = session("LedgerBalanceType")
'Search_IncludeMarginAccount   = session("IncludeMarginAccount")
'Search_Market           = session("Market")
'Search_Instrument       = session("Instrument")
'Search_SharedSelection      =  session("ShareSelection")	
...
'session("SharedGroup")           =  Search_SharedGroup        	   
'session("SharedGroupMember")     =  Search_SharedGroupMember       
'session("SDay")                  =  Search_Daily_Day               
'session("SMonth")                =  Search_Daily_Month             
'session("SYear")                 =  Search_Daily_Year              
'session("LedgerBalanceType")     =  Search_LedgerBalanceType       
'session("IncludeMarginAccount")  =  Search_IncludeMarginAccount    
'session("Market")                =  Search_Market                  
'session("Instrument")            =  Search_Instrument              
' session("ShareSelection")	     =  Search_SharedSelection         
...
Search_Statement ="Daily"
 ...
 'Rs1.open ("Exec Retrieve_ClientStatement '"&Search_ClientFrom&"', '"&Search_ClientTo&"', '"&Search_AEFrom&"', '"&Search_AETo&"', '"&Search_AEGroup&"','"&Search_Statement&"', '"&Search_Monthly_Month&"', '"&Search_Monthly_Year&"', '"&Search_Daily_Day&"', '"&Search_Daily_Month&"', '"&Search_Daily_Year&"', '"&iPageCurrent&"', '1' ") ,  StrCnn,3,1
	...
	case "share3"
			...
			Rs1.open ("Exec Retrieve_ClientSummary '"&Search_ClientFrom&"', '"&Search_ClientTo&"',  '', '', '', '"&session("shell_power")&"', '"&Search_SharedGroup&"', '"&Search_Daily_Day&"', '"&Search_Daily_Month&"', '"&Search_Daily_Year&"','"&Search_Market&"','"&Search_Instrument&"','"&Search_LedgerBalanceType&"', '"&Search_LedgerBalance&"','"&Search_IncludeMarginAccount&"', '"&iPageCurrent&"', '1' ") ,  StrCnn,3,1
	...
	case else
		'normal
			...
			Rs1.open ("Exec Retrieve_ClientSummary '"&Search_ClientFrom&"', '"&Search_ClientTo&"', '"&Search_AEFrom&"', '"&Search_AETo&"', '"&Search_AEGroup&"', '', '', '"&Search_Daily_Day&"', '"&Search_Daily_Month&"', '"&Search_Daily_Year&"','"&Search_Market&"','"&Search_Instrument&"','"&Search_LedgerBalanceType&"','"&Search_LedgerBalance&"', '"&Search_IncludeMarginAccount&"', '"&iPageCurrent&"', '1' ") ,  StrCnn,3,1
