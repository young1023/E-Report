...
'****************
   ...
   SQL1 = "select * from AsiaMileSetup where DepotNo = " & MemberID
   ...
   If Not Rs1.EoF Then
    ...
    GivenName             = trim(Rs1("GivenName"))

    FamilyName            = trim(Rs1("FamilyName"))

    Mile                  = trim(Rs1("Mile"))

    ActivityDate          = trim(Rs1("ActivityDate"))

    Membership            = trim(Rs1("Membership"))
...
<html>
<head>
<title>Asia Mile Conversion</title>
   ...
   'Initiate line number
    ...
    For i = 1 to intLength
       ...
       If strCharacter = Chr(44) Then
        ...
        'Retrieve Given Name
        If trim(delimiterNo) = Trim(GivenName) Then
        ...
        If trim(delimiterNo) = trim(FamilyName) Then
        ...
        If trim(delimiterNo) = trim(ActivityDate) Then
       ...
       If trim(delimiterNo) = trim(MemberShip) Then
...
Loop
   ...
   '
   '
   ' Retrieve content from temp table
   '
   ' ***********************************************************
